...
export const TOGGLE_CARD_LABEL_REQUEST = "TOGGLE_CARD_LABEL_REQUEST";

export const CREATE_COMMENT_REQUEST = "CREATE_COMMENT_REQUEST";
export const CREATE_COMMENT_SUCCESS = "CREATE_COMMENT_SUCCESS";

export const FETCH_LISTS_FROM_BOARD_REQUEST = "FETCH_LISTS_FROM_BOARD_REQUEST";
export const FETCH_LISTS_FROM_BOARD_SUCCESS = "FETCH_LISTS_FROM_BOARD_SUCCESS";
